#__init__(self):
# for initilize the variables

class Employee:
    def __init__(self,empname,empid,desig,salary,comnane):
...
#em=Employee("ajesh",101,"ceo",54000,"tech")
...
em=Employee (emname ,emid ,emdesig ,emsalary ,emcomp )
